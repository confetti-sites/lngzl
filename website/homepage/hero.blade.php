...
<div class="relative isolate px-6 pt-14 lg:px-8 overflow-hidden" style="    background-image: url(https://lngzl.nl/wp-content/uploads/2022/03/headerz.png);
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div class="">
            ...
            <div class="mt-10 flex gap-x-6">
                <a href="#" class="flex-none rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 cursor-pointer">{{ $hero->text('cta_text')->default('Contact') }}</a>
